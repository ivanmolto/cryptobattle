          ...
          <div className="flex justify-center mt-10 -mb-2">
            <div className="rounded-md drop-shadow-md">
              <Link
                ...
                className={`items-center justify-center rounded-md border border-1 bg-[#ff394a] px-8 py-3 text-base font-medium text-white hover:bg-red-700 md:py-6 md:px-10 md:text-lg ${
                  disabled ? "disabled" : ""
                }`}
              >
                Battle now!
